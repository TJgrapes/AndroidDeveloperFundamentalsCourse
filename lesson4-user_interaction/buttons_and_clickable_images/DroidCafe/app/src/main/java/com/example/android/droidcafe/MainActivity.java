...
public class MainActivity extends AppCompatActivity {
    ...
    // This will hold the appropriate order message; it will be updated after an dessert image is clicked
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // The fab is used to place an order and display the appropriate order message in the new activity
        // mOrderMessage changes after a dessert image icon is clicked
    ...
    /**
     * Show the Donut Order Message in the Order Activity
     */
