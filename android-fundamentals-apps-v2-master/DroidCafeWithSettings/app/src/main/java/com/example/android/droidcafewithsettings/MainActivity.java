 ...
 *
 * This version also includes the Settings option. The user clicks Settings
 * to show the Settings activity and to change the Market setting.
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "com.example.android.droidcafewithsettings.extra.MESSAGE";
