...
public class MainActivity extends Activity {
    ...
    public void onSq(View view) {
        compute(Calculator.Operator.SQ);
    }
    ...
    private void compute(Calculator.Operator operator) {
        ...
        if (operator != Calculator.Operator.SQ) {
        ...
        // Only get the first operand for the square function to avoid setting the result to error
        else {
        ...
        switch (operator) {
            ...
            case MUL:
                ...
                break;
            case SQ:
                result = String.valueOf(mCalculator.sq(operandOne));
                break;
            default:
