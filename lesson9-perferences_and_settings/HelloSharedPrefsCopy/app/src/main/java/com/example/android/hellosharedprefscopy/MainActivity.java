 ...
 */
package com.example.android.hellosharedprefscopy;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "com.example.android.hellosharedprefscopy";

    // Reference for the SharedPreferences object
    ...
    public void changeBackground(View view) {
        ...
        Toast.makeText(this, "Background color integer is " + color, Toast.LENGTH_SHORT).show();
        mColor = color;
    }
    ...
    // Implement onPause() to implement SharedPreferences
    ...
    protected void onPause() {
        ...
        // Put the state of the count and color into the shared preferences
